...
import { createAndAddExamples } from "../../../../../eval/langsmith/datasets/financeSpecialistDataset";
...
export async function runLlmJudgeEvaluation() {
  ...
  await evaluate(targetFunction, {
    ...
    experimentPrefix: "routed-agent-finance-specialist-evaluation",
    maxConcurrency: 2,
  } as EvaluateOptions);
  console.log(
    "Finance specialist evaluation run initiated. Check LangSmith UI for results.",
  );
}
